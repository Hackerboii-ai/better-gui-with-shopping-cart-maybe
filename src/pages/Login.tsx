      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <Card className="backdrop-blur-sm bg-background/95 border-0 shadow-luxury">
          <CardHeader className="text-center pb-6">
            ...
            <CardTitle className="text-2xl font-bold">Welcome to LUXE</CardTitle>
            <CardDescription>
          ...
          <CardContent>
            ...
            <div className="mt-6 p-4 bg-muted/50 rounded-lg border border-border">
              <p className="text-xs text-muted-foreground text-center">
                <strong>Demo Mode:</strong> Authentication will be fully functional once connected to Supabase backend.
              </p>
            </div>
          </CardContent>
        </Card>
